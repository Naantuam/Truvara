...
const CARDS = [
  { key: "open_decisions", label: "Open Decisions", icon: AlertCircle, iconColor: "text-blue-600", iconBg: "bg-blue-50" },
  { key: "pending_approvals", label: "Pending Approvals", icon: CheckSquare, iconColor: "text-orange-600", iconBg: "bg-orange-50" },
