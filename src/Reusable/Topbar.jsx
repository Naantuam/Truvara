...
export default function TopBar({ sidebarOpen = true, setSidebarOpen = () => { }, user = null, roles = [], loadingAuth = true }) {
  ...
  return (
    <>
      <header className="w-full bg-white dark:bg-gray-900 shadow-sm border-b border-gray-100 dark:border-gray-800 px-6 py-3 flex items-center justify-between sticky top-0 z-40">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {announcementsOpen && (
              <div className="absolute right-0 mt-2 w-80 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-xl z-50 flex flex-col max-h-[80vh] overflow-hidden">
                <div className="px-4 py-3 border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 flex justify-between items-center">
                  <h3 className="text-sm font-bold text-gray-800 dark:text-gray-100">Announcements</h3>
                </div>
                ...
                <div className="flex-1 overflow-y-auto p-2 bg-white dark:bg-gray-800 min-h-[150px] max-h-[300px]">
                  {loadingMsg ? (
                    ...
                    <div className="text-center text-gray-500 dark:text-gray-400 text-sm mt-8">No announcements yet.</div>
                  ) : (
            ...
            <div className="relative group cursor-pointer">
              ...
              <div className="absolute right-0 mt-1 w-32 bg-white dark:bg-gray-800 rounded-md shadow-lg py-1 border border-gray-100 dark:border-gray-700 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                <button
                  ...
                  className="flex items-center w-full text-left px-4 py-2 text-sm font-medium text-red-600 hover:bg-red-50 dark:hover:bg-red-950"
                >
