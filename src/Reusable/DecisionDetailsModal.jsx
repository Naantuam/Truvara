          ...
          {decision && (
            <>
              ...
              {decision.status === "Approved" && decision.resolved_by && (
                <p className="text-sm text-green-600 dark:text-green-400 mt-2">Approved by {decision.resolved_by}</p>
              )}
              {decision.status === "Rejected" && decision.rejection_reason && (
                <p className="text-sm text-red-600 dark:text-red-400 mt-2">Reason: {decision.rejection_reason}</p>
              )}
